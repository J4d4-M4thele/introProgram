...
while (numberOfGuesses > 0) {
    ...
    if (guess === secret) {
        alert("Correct " + userName + "!" + " Well done !!!")
        break;
    }
    else if (guess < secret) {
        alert("Incorrect " + userName + ", too low. You have " + numberOfGuesses +  " guesses remaining!" );
    }

    else if (guess > secret) {
        alert("Incorrect " + userName + ", too high. You have " + numberOfGuesses +  " guesses remaining!");
    }
    //Ending the game
